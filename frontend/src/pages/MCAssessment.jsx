  ...
  return (
    <div style={{ position: 'relative', height: '100%' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '380px 1fr', gap: 24, alignItems: 'start', height: PAGE_H }}>
        ...
        <div style={FORM_BODY}>
          ...
          <div className="form-group">
            ...
            {sourceMaterial && <div style={{ fontSize:'0.72rem',color:'var(--text-3)',marginTop:4 }}>AI will base all questions on your uploaded material</div>}
          </div>
      ...
      <div style={{ height: PAGE_H, display: 'flex', flexDirection: 'column', overflow: 'hidden' }} className="fade-up-1">
        {/* Output Box — always visible at top */}
